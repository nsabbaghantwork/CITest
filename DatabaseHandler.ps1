 sqlcmd -S 3.231.141.207\SQLEXPRESS -P P017btkmu1gY57m -U dbuser -i  C:\PrepareDumpDatabase.sql -o C:\Deployment_Logs\PrepareDumpDatabase_Out.txt
	
	$file = Get-Content "C:\Deployment_Logs\PrepareDumpDatabase_Out.txt"
